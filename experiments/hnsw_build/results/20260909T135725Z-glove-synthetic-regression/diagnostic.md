...
- Build time: `0.771s`
- Index size: `679936` bytes
- Approximate peak container-memory delta: `5.20 MiB`
...
- Evidence: `memory_build` has the largest measured interval (99.3% of internal elapsed time); spill=`False`.
...
- The explicit, run-specific acceptance threshold for mean Recall@K is `0.9500`.

| ef_search | Queries | Mean recall | Median | Min | Max | Median execution | Below threshold |
|---:|---:|---:|---:|---:|---:|---:|:---:|
| 40 | 10 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.4880 ms | no |
