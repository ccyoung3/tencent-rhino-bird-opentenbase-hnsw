...
|---:|---|---|---:|
| 0.001 | building index: loading tuples in memory | 0.001 / 14.081 | 15 |
| 15.088 | building index: flushing in-memory graph | 15.088 / 15.088 | 1 |

## 状态与等待样本

状态计数：`{"attached": 1, "progress_observed": 15}`
