...
|---:|---|---|---:|
| 0.002 | building index: loading tuples in memory | 0.002 / 17.153 | 18 |
| 18.156 | building index: flushing in-memory graph | 18.156 / 18.156 | 1 |

## 状态与等待样本

状态计数：`{"attached": 1, "progress_observed": 18}`
