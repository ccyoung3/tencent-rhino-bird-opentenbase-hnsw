...
|---:|---|---|---:|
| 0.002 | building index: loading tuples in memory | 0.002 / 16.096 | 17 |
| 17.099 | building index: flushing in-memory graph | 17.099 / 17.099 | 1 |

## 状态与等待样本

状态计数：`{"attached": 1, "progress_observed": 17}`
