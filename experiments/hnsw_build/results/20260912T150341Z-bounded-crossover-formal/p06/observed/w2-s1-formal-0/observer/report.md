...
|---:|---|---|---:|
| 0.005 | building index: loading tuples on disk | 0.005 / 9.107 | 10 |

## 状态与等待样本

状态计数：`{"attached": 1, "progress_observed": 8, "waiting_observed": 1}`

| 阶段 | 等待类型 / 事件 | 首次 / 末次 s | 样本数 |
|---|---|---|---:|
| building index: loading tuples on disk | IPC / ParallelCreateIndexScan | 9.107 / 9.107 | 1 |
