...
|---:|---|---|---:|
| 0.003 | build progress not published; active task unconfirmed | 0.003 / 0.262 | 2 |

## 状态与等待样本

状态计数：`{"active_without_build_progress": 2}`

| 阶段 | 等待类型 / 事件 | 首次 / 末次 s | 样本数 |
|---|---|---|---:|
| 进度尚未发布，任务类型未确认 | Lock / relation | 0.003 / 0.262 | 2 |
