...
|---:|---|---|---:|
| 0.011 | building index: loading tuples in memory | 0.011 / 3.052 | 4 |

## 状态与等待样本

状态计数：`{"waiting_observed": 1, "progress_observed": 3}`

| 阶段 | 等待类型 / 事件 | 首次 / 末次 s | 样本数 |
|---|---|---|---:|
| building index: loading tuples in memory | IO / DsmAllocate | 0.011 / 0.011 | 1 |
