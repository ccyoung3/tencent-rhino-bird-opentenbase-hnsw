...
|---:|---|---|---:|
| 0.008 | building index: loading tuples in memory | 0.008 / 0.008 | 1 |
| 1.015 | building index: loading tuples on disk | 1.015 / 22.173 | 22 |

## 状态与等待样本

状态计数：`{"attached": 1, "progress_observed": 22}`
