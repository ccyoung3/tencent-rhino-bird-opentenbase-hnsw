...
|---:|---|---|---:|
| 0.007 | building index: loading tuples in memory | 0.007 / 0.007 | 1 |
| 0.264 | building index: loading tuples on disk | 0.264 / 4.351 | 17 |

## 状态与等待样本

状态计数：`{"attached": 1, "progress_observed": 17, "ended_unconfirmed": 1}`
