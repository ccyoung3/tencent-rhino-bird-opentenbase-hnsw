...
- Build time: `32.497s`
- Index size: `74489856` bytes
- Approximate peak container-memory delta: `323.27 MiB`
...
|---|---:|---:|---:|---:|---:|
| building index: loading tuples in memory | 0.007s | 30.971s | 30.963s | 0.000%–98.993% | 41 |
| building index: flushing in-memory graph | 31.754s | 31.754s | 0.000s | 99.996%–99.996% | 1 |

## Internal build timing

- Timing status: `complete`.
- Internal HNSW elapsed wall time: `32.260982s`.
- One leader timeline; not summed worker CPU time, full CREATE INDEX time, or commit latency.

| Internal phase | Elapsed |
|---|---:|
| setup | 0.000132s |
| memory_build | 31.435870s |
...
- Evidence: `memory_build` has the largest measured interval (97.4% of internal elapsed time); spill=`False`.
