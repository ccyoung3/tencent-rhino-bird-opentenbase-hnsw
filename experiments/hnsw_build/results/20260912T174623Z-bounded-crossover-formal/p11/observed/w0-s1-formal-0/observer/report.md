...
|---:|---|---|---:|
| 0.002 | building index: loading tuples in memory | 0.002 / 0.002 | 1 |
| 1.014 | building index: loading tuples on disk | 1.014 / 16.132 | 16 |

## 状态与等待样本

状态计数：`{"attached": 1, "progress_observed": 16}`
