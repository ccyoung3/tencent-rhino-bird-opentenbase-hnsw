...
|---:|---|---|---:|
| 0.002 | building index: loading tuples in memory | 0.002 / 19.114 | 20 |

## 状态与等待样本

状态计数：`{"attached": 1, "progress_observed": 19, "ended_unconfirmed": 1}`

| 阶段 | 等待类型 / 事件 | 首次 / 末次 s | 样本数 |
|---|---|---|---:|
| 进度尚未发布，任务类型未确认 | IO / WalWrite | 20.121 / 20.121 | 1 |
