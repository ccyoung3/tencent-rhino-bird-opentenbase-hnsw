...
|---:|---|---|---:|
| 0.002 | building index: loading tuples in memory | 0.002 / 19.154 | 20 |
| 20.160 | building index: flushing in-memory graph | 20.160 / 20.160 | 1 |

## 状态与等待样本

状态计数：`{"attached": 1, "progress_observed": 20}`
