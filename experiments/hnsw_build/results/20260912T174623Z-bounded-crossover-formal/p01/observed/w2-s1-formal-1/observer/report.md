...
|---:|---|---|---:|
| 0.006 | building index: loading tuples on disk | 0.006 / 11.087 | 12 |

## 状态与等待样本

状态计数：`{"attached": 1, "progress_observed": 10, "waiting_observed": 1}`

| 阶段 | 等待类型 / 事件 | 首次 / 末次 s | 样本数 |
|---|---|---|---:|
| building index: loading tuples on disk | LWLock / BufferContent | 5.039 / 5.039 | 1 |
